...
//    private static int requestsCounter = 0;
    ...
    public RequestProducer(HotelRequestGenerator hotelRequestGenerator, RequestManager requestManager,
                           RequestsQueueDao requestsQueueDao) {
...
//        this.maxRequests = maxRequests;
    ...
    @Override
    public void run() {
        while (requestManager.canProceed()) {
